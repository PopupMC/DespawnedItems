...
public class LocationEntry {
    ...
    public LocationEntry(int x, int y, int z, @NotNull World world, @NotNull UUID owner, @NotNull DespawnedItems2 plugin) {
        this.location = new Location(world, x, y, z);
        this.owner = owner;
        this.plugin = plugin;
    }

    public LocationEntry(@NotNull Location location, @NotNull UUID owner, @NotNull DespawnedItems2 plugin) {
